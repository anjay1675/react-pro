...
<div class="animate1 seven1">
    <span id="spa2">f</span><span>o</span><span>r</span>&nbsp;&nbsp;
...
<h2 id="same">Same day! Next day! when!</h2>
<Row className="rowx">

<Col id="colx">
<h5>Flight Services</h5>
    <img src="./images/flight10.jpeg"
        width="360px"
        height="280px"
        alt= "moov africa image"
    />
    <h3 id="he">Beyond Africa</h3>
    <h6 id="jan">Jan - Dec 2020</h6>
    <p id="za">We would always beat your imagination, and even more. 
...
<h5>Heavy Load</h5>
    ...
    <h6 id="jan">Jan - Dec 2020</h6>
    <p id="za">We would always beat your imagination, and even more. 
    Our staff are always very courteous and would always attend to your</p>
</Col>
</Row>  
